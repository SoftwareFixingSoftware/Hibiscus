          ...
          <div className="hib-form-container">
            <div className="hib-form-wrapper">
              <div className="hib-form-header">
                ...
                <h2 id="signup-heading" className="hib-form-title">
                  Create Admin Account
                </h2>
                <p className="hib-form-switch">
                  Already have an account?{' '}
                  <Link to="/login" className="hib-form-link">
                    Sign in here
                  </Link>
                </p>
              </div>
              ...
              <form onSubmit={submit} className="hib-form" aria-describedby={error ? 'form-error' : undefined}>
                <div className="hib-form-grid">
                  <div className="hib-form-group">
                    <label className="hib-form-label" htmlFor="name">
                      Full Name *
                    </label>
                    <input
                      id="name"
                  ...
                  <div className="hib-form-group">
                    <label className="hib-form-label" htmlFor="username">
                      Username (optional)
                    </label>
                    <input
                      id="username"
                ...
                <div className="hib-form-group">
                  <label className="hib-form-label" htmlFor="email">
                    Email Address *
                  </label>
                  <input
                    id="email"
                ...
                <div className="hib-form-grid">
                  <div className="hib-form-group">
                    <label className="hib-form-label" htmlFor="password">
                      Password *
                    </label>
                  ...
                  <div className="hib-form-group">
                    <label className="hib-form-label" htmlFor="confirmPassword">
                      Confirm Password *
                    </label>
                    <div className="hib-password-container">
                      <input
                ...
                <div className="hib-form-group">
                  <label className="hib-form-label" htmlFor="adminCode">
                    Admin Invite Code *
                  </label>
                  <div className="hib-password-container">
                    <input
                ...
                <div className="hib-form-checkbox">
                  ...
                  <label htmlFor="tos" className="hib-checkbox-text">
                    I agree to the{' '}
                    <Link to="/terms" className="hib-checkbox-link">
                      Terms of Service
                    </Link>
                    ,{' '}
                    <Link to="/privacy" className="hib-checkbox-link">
                      Privacy Policy
                    </Link>
                    , and{' '}
                    <Link to="/cookies" className="hib-checkbox-link">
                      Cookie Policy
                    </Link>
                    .
                  </label>
              ...
              <div className="hib-divider-section">
                <div className="hib-divider">
                  <span className="hib-divider-text">
                    Admin accounts must be created with email & password
                  </span>
                </div>
                <p className="hib-text-sm hib-text-muted">
                  Social sign-ups are disabled for admin creation for security reasons.
                </p>
              </div>
            </div>
          </div>
