  ...
  return (
    <div className="hib-social-buttons">
      <motion.button 
        ...
        className={`hib-btn-social hib-btn-github ${disabled ? 'hib-btn-disabled' : ''}`}
        disabled={disabled}
      >
        <svg className="hib-social-icon" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div id="hib-googleButton" className="hib-google-button-wrapper">
        <motion.button 
          ...
          whileHover={!disabled ? { scale: 1.02 } : {}}
          whileTap={!disabled ? { scale: 0.98 } : {}}
          className={`hib-btn-social hib-btn-google ${disabled ? 'hib-btn-disabled' : ''}`}
          disabled={disabled}
        >
          <svg className="hib-social-icon" viewBox="0 0 24 24">
